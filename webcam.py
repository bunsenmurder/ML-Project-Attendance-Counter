...
face_cascade = cv2.CascadeClassifier('models/Model3_4e-5.xml')
# This is our second best model, using the model 3 template with an abv of 10e-6.
face_cascade2 = cv2.CascadeClassifier('models/Model3_10e-6.xml')
...
while True:
    ...
    cv2.imshow('Model3_4e-5', frame)
    cv2.imshow('Model3_10e-6', frame2)
